# agents/ik/ppo_agent_vision_IKsimple.py
...
from networks.ik.ppo_vision_IKsimple import PPOvision  # your conv-based PPO class
...
class PPOAgentVision:
    def __init__(
        ...
        self.model = PPOvision(obs_shape, action_shape).to(self.device)
