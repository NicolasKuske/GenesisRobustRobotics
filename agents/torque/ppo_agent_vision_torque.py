# agents/ppo_agent_vision_torque.py
...
from networks.torque.ppo_vision_torque import PPOVisionTorque  # your new conv–Gaussian PPO networks
...
class PPOAgentVisionTorque:
    def __init__(
        ...
        # actor–critic conv–Gaussian networks
