...
class ReachCubeEgoVisionStackedTorqueEnv:
    ...
    def __init__(
        ...
        # History settings: sim dt=0.01 → 100 Hz → 20 steps = 200 ms
        self.history_length = 20
        # sample frames at these offsets
    ...
    def _init_robot(self):
        # set initial joint positions, lock fingers
    ...
    def reset(self):
        ...
        # sample cube for new stage/position
        ...
        # measure initial distance for shaping
    ...
    def step(self, actions: torch.Tensor):
        ...
        # render new frame and update history
...
if __name__ == "__main__":
    ...
    env = ReachCubeEgoVisionStackedTorqueEnv(vis=True, device=torch.device("cuda"))
    obs = env.reset()
    for t in range(100):
