# network/ppo_audio_torque.py
import torch
import torch.nn as nn

class PPOAudioTorque(nn.Module):
    """
    Convolutional Actor-Critic network for PPO with continuous torque outputs.
    ...
    def __init__(self, obs_shape, action_dim, hidden_dim=256):
        ...
        C, F, T = obs_shape
        # 1) Convolutional trunk (adapted from simple audio network)
