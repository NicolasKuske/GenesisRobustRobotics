...
def train_ppo(args):
    ...
    for update in range(1, num_updates + 1):
        ...
        # stop training if curriculum complete
        if hasattr(env, 'completed') and env.completed:
            print("[INFO] Curriculum complete—saving final checkpoint and exiting.")
            agent.save_checkpoint()
            break
...
def arg_parser():
    ...
    p.add_argument('--total_timesteps', type=int, default=1_000_000_000,
    ...
    p.add_argument('--num_episodes', type=int, default=1_000_000,
