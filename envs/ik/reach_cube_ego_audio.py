...
class ReachCubeEgoAudioEnv:
    ...
    The agent receives a (1×257×9) spectrogram each step, optionally plays and plots one envs's audio every `show_every` steps.
    ...
    def reset(self) -> torch.Tensor:
        """Reset envs, use fixed initial pos for episode 1, then randomize every randomize_every episodes."""
